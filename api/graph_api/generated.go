...
type Resolvers interface {
	Mutation_createTodo(ctx context.Context, text string, done *bool) (Todo, error)
	Mutation_updateTodos(ctx context.Context, ids []int, changes map[string]interface{}) ([]Todo, error)
	Mutation_deleteTodos(ctx context.Context, ids []int) ([]Todo, error)
	Query_todo(ctx context.Context, id int) (*Todo, error)
	Query_todos(ctx context.Context, status *string) ([]Todo, error)
}
